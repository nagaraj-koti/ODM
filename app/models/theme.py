...
# --text: #363537ff;
# --secondary: #fffffcff;
# --forest-green: #279037ff;
# --primary: #ff7f11ff;
# --tertiary: #2966e0ff;

    # Similar to how discourse.org does it
    primary = ColorField(default='#363537ff', help_text=_("Most text, icons, and borders."), verbose_name=_("Primary"))
    secondary = ColorField(default='#fffffcff', help_text=_("The main background color, and text color of some buttons."), verbose_name=_("Secondary"))
    tertiary = ColorField(default='#2966e0ff', help_text=_("Navigation links."), verbose_name=_("Tertiary"))

    button_primary = ColorField(default='#ff7f11ff', help_text=_("Primary button color."), verbose_name=_("Button Primary"))
    button_default = ColorField(default='#2966e0ff', help_text=_("Default button color."), verbose_name=_("Button Default"))
    button_danger = ColorField(default='#e74c3c', help_text=_("Delete button color."), verbose_name=_("Button Danger"))

    header_background = ColorField(default='#fffffcff', help_text=_("Background color of the site's header."), verbose_name=_("Header Background"))
    header_primary = ColorField(default='#279037ff', help_text=_("Text and icons in the site's header."), verbose_name=_("Header Primary"))

    border = ColorField(default='#2966e0ff', help_text=_("The color of most borders."), verbose_name=_("Border"))
