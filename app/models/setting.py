...
class Setting(models.Model):
    ...
    organization_name = models.CharField(default='INDRONE', max_length=255, blank=True, null=True, help_text=_("The name of your organization"), verbose_name=_("Organization name"))
    organization_website = models.URLField(default='https://indroneaerosys.com/', max_length=255, blank=True, null=True, help_text=_("The website URL of your organization"), verbose_name=_("Organization website"))
